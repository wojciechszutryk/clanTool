...
export const setStationsNames = (stationsNames: string[]): actions.ActionSetStationsNames => ({
...
export const setMapReference = (mapReference: any): actions.ActionSetMapReference => ({
  type: types.SET_MAP_REFERENCE,
  mapReference,
});

export const setStartDate = (startDate: number): actions.ActionSetStartDate => ({
...
export const setChartsToShow = (chartsToShow: ChartTypes[]): actions.ActionSetChartsToShow => ({
  type: types.SET_CHARTS_TO_SHOW,
  chartsToShow,
});

export const setMADMultiply = (MADMultiply: number): actions.ActionSetMADMultiply => ({
