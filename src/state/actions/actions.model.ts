...
export interface ActionSetStationsNames extends Action<typeof types.SET_STATIONS_NAMES> {
  stationsNames: string[];
}

export interface ActionSetSatellitesNames extends Action<typeof types.SET_SATELLITES_NAMES> {
...
export interface ActionSetMapReference extends Action<typeof types.SET_MAP_REFERENCE> {
  mapReference: any;
}

export interface ActionSetStartDate extends Action<typeof types.SET_START_DATE> {
  startDate: number;
}
...
export interface ActionSetChartsToShow extends Action<typeof types.SET_CHARTS_TO_SHOW> {
  chartsToShow: ChartTypes[];
}

export interface ActionSetMADMultiply extends Action<typeof types.SET_MAD_MULTIPLY> {
  MADMultiply: number;
}
