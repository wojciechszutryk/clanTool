...
export const chartInstructions: Instruction[] = [
  ...
  {
    title: 'Details',
    description: 'Point details. You can see more information about point by hovering over it.',
    top: 14,
    left: 30,
  },
  {
  ...
  },
  {
    ...
    description: 'Clock noises visualize how rapidly the values ​​change over a given range',
    top: 90.5,
    left: 10,
  },
  {
